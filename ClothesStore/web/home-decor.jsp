 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  <a href="Controller?page=all-products" class="list-group-item" style="background:  #b08069;">
						    All Products
						  </a>
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'home decor' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center"><a style="color: rgb(48, 47, 47);"><c:out value="${product.getName() }"></c:out></a></div>	
