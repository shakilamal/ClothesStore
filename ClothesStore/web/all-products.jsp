		...
		<nav>
			<ul>
				...
				<c:choose>
					...
					<c:when test="${session != null}">
						<li><a href="Controller?page=logout" style="color: #cb49af;">Logout</a></li>
 		...
 		<div class="row">
 				<div class="col-md-4">
 						<div class="list-group">
						  <a href="Controller?page=all-products" class="list-group-item" style="background:  #e3b096;">
						    All Products
						  </a>
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center"><a style="color: rgb(26, 21, 21);"><c:out value="${product.getName() }"></c:out></a></div>	
